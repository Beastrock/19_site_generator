...
def convert_article_markdown_to_html(template, article_markdown, article_info):
...
def create_index_page_from_template(environment, config):
...
def create_articles_from_html_template(environment, config):
    articles_info = config["articles"]
    ...
    for article_info in articles_info:
        ...
        article_html = convert_article_markdown_to_html(article_page_template,
...
if __name__ == "__main__":
    ...
    create_index_page_from_template(env, config)
    create_articles_from_html_template(env, config)